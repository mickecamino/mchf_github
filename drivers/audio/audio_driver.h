...
//
#define	DSP_NOTCH_BUFLEN_MIN	96		// minimum length of decorrelation buffer for the notch filter FIR
#define	DSP_NOTCH_BUFLEN_MAX	LMS_NOTCH_DELAYBUF_SIZE_MAX	// maximum decorrelation buffer length for the notch filter FIR
#define	DSP_NOTCH_DELAYBUF_DEFAULT	192	// default decorrelation buffer length for the notch filter FIR
//
#define	DSP_NOTCH_MU_MAX		35		// maximum "strength" (convergence) setting for the notch
#define	DSP_NOTCH_MU_DEFAULT	10		// default convergence setting for the notch
//
